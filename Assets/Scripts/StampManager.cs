...
public class StampManager : MonoBehaviour
{
    ...
    //    { 
    //        Vector3 mousePosition = GetMouseWorldPosition();
    //        GameObject triangle = Instantiate(trianglePrefab, mousePosition, Quaternion.identity);
    //        triangle.tag = "Line(Clone)";
    //    }
    //}
    //public void SquareStamp()
    ...
    //    { 
    //        Vector3 mousePosition = GetMouseWorldPosition();
    //        GameObject square = Instantiate(squarePrefab, mousePosition, Quaternion.identity);
    //        square.tag = "Line(Clone)";
    //    }
    //}
